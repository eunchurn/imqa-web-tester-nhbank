...
export default function RouteTestPage2() {
  return (
    <IMQAProvider>
      <div className="space-y-6">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold">Route Test - Page 2</h1>
          ...
          <div className="md:col-span-3">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  This is Page 2 of the route test. IMQA should track the navigation between different routes.
                  Click the buttons below to navigate to different routes and observe the tracking in IMQA.
                </p>

                <div className="flex flex-wrap gap-3">
                  <Link href="/route-test-1">
